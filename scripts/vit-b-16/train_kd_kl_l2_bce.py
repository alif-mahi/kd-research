...
def train_single_seed(
    ...
    paths = create_output_dirs(output_base, 'vit-b-16_kl_l2_bce', seed)
...
def main():
    ...
    if all_results:
        ...
        aggregated_path = os.path.join(args.output, 'metrics', 'vit-b-16_kl_l2_bce', 'aggregated_results.json')

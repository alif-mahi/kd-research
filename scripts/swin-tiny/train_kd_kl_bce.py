...
from trainers.teacher_trainer import TeacherTrainer; from trainers.student_kl_bce import StudentTrainer_KL_BCE as StudentTrainer
...
def train_single_seed(
    ...
    paths = create_output_dirs(output_base, 'swin-tiny', seed)
    ...
    if all_results:
        ...
        aggregated = {
            ...
            'metadata': {
                ...
                'teacher_architecture': 'Swin-Tiny'
            }
        }
        
        # Save aggregated results
        aggregated_path = os.path.join(args.output, 'metrics', 'swin-tiny', 'aggregated_results.json')

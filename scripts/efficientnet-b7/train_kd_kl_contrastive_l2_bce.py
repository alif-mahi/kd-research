...
def train_single_seed(
    ...
    paths = create_output_dirs(output_base, 'efficientnet-b7_kl_contrastive_l2_bce', seed)
    ...
    if all_results:
        ...
        aggregated = {
            ...
            'metadata': {
                ...
                'teacher_architecture': 'efficientnet-b7_kl_contrastive_l2_bce'
            }
        }
        
        # Save aggregated results
        aggregated_path = os.path.join(args.output, 'metrics', 'efficientnet-b7_kl_contrastive_l2_bce', 'aggregated_results.json')

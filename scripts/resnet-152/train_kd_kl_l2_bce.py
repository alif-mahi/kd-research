...
def train_single_seed(
    ...
    paths = create_output_dirs(output_base, 'resnet152_kl_l2_bce', seed)
...
def main():
    ...
    if all_results:
        ...
        aggregated_path = os.path.join(args.output, 'metrics', 'resnet152_kl_l2_bce', 'aggregated_results.json')
